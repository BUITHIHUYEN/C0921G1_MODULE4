...
<body>
<h1 style="color: crimson">TỜ Khai Y Tế</h1>
<h1>Đây là tài liệu quan trọng, thông tin của anh/chị sẽ giúp cơ quan y tế liên lạc khi cần thiết để phòng chống dịch bệnh truyền nhiễm </h1>
<h2> Khuyến cáo khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể xử lí hình sự</h2>

<form:form modelAttribute="medicalDeclaratons"  action="/list" method="post">
    <table>
        <tr>
